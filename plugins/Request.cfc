component name = "Request" output = "false"
{
    ...
    * @prefix option to return struct of details (just filecontent by default)
    */
	public any function request(required string url, string verb = "GET", array fields = [], string content = "", boolean prefix = false)
	{
        ...
        var response = myHttp.send().getPrefix();
        if(!arguments.prefix) {return response.fileContent;}
        return response;
	}
